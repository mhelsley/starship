...
impl<'a> Default for DirectoryConfig<'a> {
    fn default() -> Self {
        DirectoryConfig {
            ...
            format: "[[[$path]($style)[$read_only]($read_only_style)][file://$raw_path]] ",
            repo_root_format: "[[[$before_root_path]($before_repo_root_style)[$repo_root]($repo_root_style)[$path]($style)[$read_only]($read_only_style)][file://$raw_path]] ",
            style: "cyan bold",
